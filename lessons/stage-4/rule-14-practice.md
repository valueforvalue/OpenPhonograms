...
|------|-----------|--------|----------|------------|-------|
| running | run + n + ing | Rule 14: 1-1-1 | /rŭn-ing/ |
...
1. What three things must be true to double the consonant? *(1 syllable, 1 vowel, 1 final consonant.)*
