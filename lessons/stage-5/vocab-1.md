# Lesson 27: Vocabulary: Tier 2 Words in Context

**Stage 5** · Lesson 27 · vocabulary

---

## Warm-Up: Word of the Day

> Today's word: **analyze** — to examine carefully and in detail

---

## New Learning: Tier 2 Vocabulary
...
Use each word in a sentence about spelling or reading:
...
> Analyze the spelling of 'transport.' Compare it to 'portable.' Contrast the prefixes. Describe how the root 'port' works. Explain the meaning of each word.

---

## Quick Check

1. What is a Tier 2 word? *(An academic word used across many subjects.)*
2. Give a new example of a Tier 2 word.
3. Use 'analyze' in a sentence.

---

**Next lesson:** Lesson 28: Vocab: Synonyms
