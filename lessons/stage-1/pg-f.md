...
<summary>📖 Phonogram f — Teacher Script (click to expand)</summary>

> **Say:** "Today we are going to learn a new phonogram. A phonogram is a letter or group of letters that makes one or more sounds."

<div class="phonogram">f</div>

> **Say:** "This is the phonogram **f**." *(Point to the card.)* "It says /f/."

> **Say:** "Listen to me say its sounds: /f/. Now you say them."

> *(Child repeats.)*

> **Say:** "Good. Now let's write it. Watch me first." *(Demonstrate writing f.)*

> **Say:** "Now you write **f** three times. Say '/f/' each time you write it."
...
> **Say:** "What did you learn today?" *(Child responds: "The phonogram f — it says /f/.")*
