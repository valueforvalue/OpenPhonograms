...
## New Learning: Your First Phonogram — a

### The Phonogram **a**

<div class="phonogram">a</div>

**a** says three sounds: /ă/ /ā/ /ä/
...
> **Important:** Always teach ALL sounds from the start. Never teach "a says /ă/" and add more later. The child must know that **a** can say three different things.
...
2. **Segment** — Child breaks the word into individual sounds. Adult holds up fingers.
...
> *(At this stage, the child may only know these 3 words plus a few phonograms. That's fine! We build from here.)*
...
*Practice at home: Flash your new **a** card 5 times today. Find the letter **a** in a book or on a sign.*
