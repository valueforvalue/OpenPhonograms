...
<summary>📖 Phonogram d — Teacher Script (click to expand)</summary>

> **Say:** "Today we are going to learn a new phonogram. A phonogram is a letter or group of letters that makes one or more sounds."

<div class="phonogram">d</div>

> **Say:** "This is the phonogram **d**." *(Point to the card.)* "It says /d/."

> **Say:** "Listen to me say its sounds: /d/. Now you say them."

> *(Child repeats.)*

> **Say:** "Good. Now let's write it. Watch me first." *(Demonstrate writing d.)*

> **Say:** "Now you write **d** three times. Say '/d/' each time you write it."
