# Lesson 52: High-Frequency Words — Set 2
...
O says /ö/ — just like 'to'. Say-to-spell: /dö/.

### was

W before A: A says /ä/ (Rule 10). S says /z/ at the end. Say-to-spell: /wŏz/.

### has

A says /ă/. S says /z/ at the end. Say-to-spell: /hăz/.

### said

AI says /ĕ/ here — this is one of very few words where AI says /ĕ/. Say-to-spell: /sād/ to remember the AI.

### you

OU says /ö/ here. It's a very common word. Say-to-spell: /yō/.
...
|------|----------------|---------------|--------------|
| do | (see explanation above) | (see above) | (see above) |
| was | (see explanation above) | (see above) | (see above) |
| has | (see explanation above) | (see above) | (see above) |
| said | (see explanation above) | (see above) | (see above) |
| you | (see explanation above) | (see above) | (see above) |
...
3. Spell "you" from dictation.

---

**Next lesson:** Lesson 53: HF Words Set 3
