...
A says /ä/ (Rule 10, before R). Silent E. AR rows /är/. Say-to-spell: /är/.

### have

A says /ă/. Silent E is here because of Rule 3 — no English word ends in V. Say-to-spell: /hăv/.

### give

Short I says /ĭ/. G says /g/ (it may soften before I, but doesn't here). Silent E because of Rule 3 (no V at end). Say-to-spell: /gĭv/.

### come

O says /ŭ/. Silent E is Rule 12.9 — the unseen reason. Say-to-spell: /kōm/ to remember the O, then read as /kŭm/.

### some

O says /ŭ/. Silent E — Rule 12.9. Say-to-spell: /sōm/ to remember O.
...
|------|----------------|---------------|--------------|
| are | (see explanation above) | (see above) | (see above) |
| have | (see explanation above) | (see above) | (see above) |
| give | (see explanation above) | (see above) | (see above) |
| come | (see explanation above) | (see above) | (see above) |
| some | (see explanation above) | (see above) | (see above) |
