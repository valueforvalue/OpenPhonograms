# Phonogram Flash Cards — Single-Letter Phonograms (Page 6 of 7)
...
<div class="phonogram-sounds" style="font-size:12pt; color:#555;">/v/</div>
</div>
<div class="phonogram-card" style="display:inline-block; width:45%; margin:2%; border:2px solid #2a5c8a; border-radius:8px; padding:20px; text-align:center; page-break-inside:avoid;">
<div class="phonogram-letter" style="font-size:60pt; font-weight:bold; color:#2a5c8a; font-family:Georgia,serif;">w</div>
<div class="phonogram-sounds" style="font-size:12pt; color:#555;">/w/</div>
</div>
<div class="phonogram-card" style="display:inline-block; width:45%; margin:2%; border:2px solid #2a5c8a; border-radius:8px; padding:20px; text-align:center; page-break-inside:avoid;">
<div class="phonogram-letter" style="font-size:60pt; font-weight:bold; color:#2a5c8a; font-family:Georgia,serif;">x</div>
<div class="phonogram-sounds" style="font-size:12pt; color:#555;">/ks/ /z/</div>
</div>
